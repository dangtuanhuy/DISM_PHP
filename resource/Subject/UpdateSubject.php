...
function bindUpdateSub($conn, $selectedValue)
{
	$sqlstring = "SELECT `SubjectId`, `SubjectName`, `SubjectTheory`, `SubjectPractical`, `TheoryPractical`, `SubjectSem`, `EducationName` FROM `subject`
    JOIN education ON subject.EducationId = education.EducationId";
