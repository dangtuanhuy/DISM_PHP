...
<div class="container-fluid">
	...
	<form name="frmXoa" method="post" action="">
		...
		<p>
			<a  class="btn btn-success" href="?page=addsub">
				ADD
			</a>
		...
		<table class="table-striped table-responsive table-bordered" id="myTable">
			<thead>
				<tr>
                    ...
                    <th ><strong>EDU</strong></th>
					<th class="col-3"><strong>Delete</strong></th>
					<th class="col-3"><strong>Update</strong></th>
				</tr>
			</thead>
			<tbody>
				<?php 
    ...
    JOIN `education` ON subject.EducationId = education.EducationId");
			while ($row = mysqli_fetch_array($result, MYSQLI_ASSOC)) {
				?>
					<tr>
						<td><input name="checkbox[]" type="checkbox" id="checkbox[]"  class="form-control" value="<?php echo $row["SubjectId"] ?>"></td>
						<td><?php echo $num ?></td>
						...
						<td align='center'>
							<a class="btn btn-danger"   href="?page=sub&ma=<?php echo $row['SubjectId']; ?>" onclick="return deleteConfirm()">
								Delete</a>
						</td>
						<td>
						<a class="btn btn-primary" href="?page=subjectupdate&ma=<?php echo $row['SubjectId']; ?>">Update</a>
						</td>
						</tr>
						<?php
					$num++;
